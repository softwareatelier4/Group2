...
module.exports = {
	...
	'indexUI Tests': function(page) {
		page
			...
			.setValue('input[id=firstName]', 'Vincenzo')
			...
			.setValue('input[id=phone]', '6789')
			.assert.visible('input[id=city]')
			.clearValue('input[id=city]')
			.setValue('input[id=city]', 'Ronco Briantino')
			...
			.setValue('textarea[id=description]', 'Zappo a vignhyl')
